        ...
        <div className="min-h-[66vh] md:min-h-screen bg-cover bg-center flex items-center justify-center text-white px-4 sm:px-6 md:px-12 lg:px-20 bg-gray-900 bg-[url('/images/AboutBannerAxodian.webp')]">
            <div className="text-center">
                ...
                <p className="text-sm sm:text-lg md:text-2xl mt-2 sm:mt-4 max-w-4xl mx-auto text-gray-300 px-2">
                    <span className="md:block mb-2">At <span className="font-extrabold">Axodian</span>, we simplify international trade through a trusted portfolio of solutions that automate documentation and compliance, and streamline payments.</span>
                </p>
                <Button onClick={onExploreClick} className="p-6 text-primary-color text-base md:text-lg font-semibold rounded-lg bg-white hover:bg-white/90 shadow-lg mt-6">
                    Learn More
                </Button>
            </div>
        </div>

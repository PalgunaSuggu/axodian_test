        ...
        <div className="py-16 md:py-24 bg-cover bg-center bg-black/90 bg-[url('/images/LeDocBenefitsAxodian.webp')]">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-6">
                    <Image src="/images/team01.webp" alt="Main Visual" width={300} height={400} className="rounded-lg shadow-lg w-full max-w-[400px] h-auto" />

                    <div className="flex flex-col gap-6">
                        <Image src="/images/team02.webp" alt="Team Collaboration" width={500} height={500} className="rounded-tr-3xl shadow-lg w-full max-w-[400px] h-auto" />
                        <Image src="/images/team03.webp" alt="Innovation Space" width={500} height={500} className="rounded-br-3xl shadow-lg w-full max-w-[400px] h-auto" />
                    </div>
                </div>

                <div className="text-white text-center md:text-left">
                    <h1 className="leading-snug">Join Us</h1>
                    <p className="mt-2 text-lg md:text-xl">
                        <span className="opacity-65">Build the Future of Trade with</span>{' '}
                        <span className="font-semibold">Axodian</span>
                    </p>
                    <p className="mt-4 text-lg md:text-xl opacity-65">At LeRemitt, we are not just redefining global trade—we are building a smarter, more seamless future. If you are passionate about innovation, technology, and making a real impact, we would love to have you on board.</p>

    ...
    <div className="relative flex min-h-screen w-full items-center justify-center">
      ...
      <div className="container relative z-10 mx-auto px-4 py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-4xl text-center">
          {/* Heading */}
          <h1 className="mb-6 text-4xl font-bold leading-tight sm:text-5xl md:text-6xl lg:mb-8">
          ...
          <div className="mb-14 flex flex-col justify-center gap-4 sm:mb-16 sm:flex-row md:mb-20">
            <Button size="lg" className="text-lg py-6 px-8 bg-primary-light-color/30 hover:bg-primary-light-color/50 transition-colors duration-200">
              Book a 20-minute walkthrough
            </Button>
            
            <Button asChild variant="outline" size="lg" className="text-lg py-6 px-8 bg-transparent border-solid border-primary-light-color/60 text-white hover:bg-primary-light-color/30 hover:text-white transition-colors duration-200">
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-x-8 gap-y-4 text-base text-gray-400 sm:flex-row">
            {features.map((feature, index) => (
              <div key={index} className="flex items-center">
                <feature.icon 
                  className={`mr-2 h-5 w-5 flex-shrink-0 ${feature.color}`} 
                  aria-hidden="true"
                />

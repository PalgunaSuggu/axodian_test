        ...
        <div className=" w-full relative flex items-center justify-center">
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10 py-16 lg:py-28">
                <div className="flex flex-col items-center justify-center">
                    <h1 className="leading-tight text-center mb-4 md:mb-6">
                ...
                <div className="mx-auto container">
                    <div className="grid md:grid-cols-2 gap-8 md:gap-12 mb-12">
                        <div>
                            ...
                            <p className="text-base md:text-base max-w-md text-slate-400 mt-4 md:mt-6">
                                Documentation and payments in one connected environment. Move faster with confidence in global trade.
                            </p>
                        </div>

                        <div className="md:text-right space-y-4 md:space-y-5 mt-6 md:mt-0">
                            <div>
                                <Link href="mailto:connect@axodian.com" className="text-base text-slate-500 hover:text-secondary-light-color transition-colors">connect@axodian.com</Link>
                            </div>
                            <div className="text-base text-slate-500">1185, 5th Main Road, 7th Sector, HSR Layout Bengaluru, 560102</div>
                        </div>
                    </div>

                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 md:gap-6 text-sm text-slate-500">
                        <div>
                            &copy; {new Date().getFullYear()} Axodian. All rights reserved.
                        </div>
                        <div className="flex gap-6 md:gap-8 mt-4 sm:mt-0">
                            <Link href="#" className="text-sm hover:text-secondary-light-color transition-colors">Privacy</Link>
                            <Link href="#" className="text-sm hover:text-secondary-light-color transition-colors">Terms</Link>
                        </div>
                    </div>
                </div>
            </div>

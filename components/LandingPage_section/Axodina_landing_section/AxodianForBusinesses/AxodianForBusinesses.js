      ...
      <section className="relative z-10 py-20 lg:pb-32">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-5xl mx-auto mb-16">
            <h1 className="leading-tight text-slate-900 mb-6">Built for growing exporters and importers</h1>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {businessTypes.map((business, index) => {
              ...
              return (
                <div key={index}className="group bg-white/45 backdrop-blur-xl rounded-xl p-8 hover:shadow-lg hover:shadow-primary-color/30 hover:scale-105 transition-all duration-300 border border-slate-100 hover:border-primary-color/20">
                  ...
                  <h5 className="leading-tight text-slate-900 mb-3">{business.title}</h5>

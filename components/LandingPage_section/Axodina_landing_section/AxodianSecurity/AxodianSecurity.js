                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-4xl mx-auto mb-16">
                        ...
                        <p className="text-lg text-slate-600">
                            Enterprise-grade protection for your trade operations
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto mb-16">
                        {features.map((feature, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className="flex gap-6 p-8 bg-white/30 rounded-2xl hover:shadow-lg transition-all duration-300 border border-slate-100 hover:border-primary-color/20"
                                >
                    ...
                    <div className="text-center">
                        <Button
                            variant="outline"
                            size="lg"
                            className="border-primary-color text-primary-color hover:bg-primary-color/5 hover:border-primary-color/80 transition-colors duration-300 px-8 py-6 text-base"
                        >

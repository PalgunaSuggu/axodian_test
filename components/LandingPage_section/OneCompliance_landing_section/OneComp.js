...
const OneComp = () => {
  return (
    <div>
      ...
      <Register subtitleOne="Make EBRC generation" subtitleTwo="and EDPMS reconciliation effortless." subtitleThree="" description="Be among the first to try One Compliance and simplify your workflow from day one." buttonText="Book a 15-min Demo" defaultSelected={['document_management']} dialogComponent={LeDocDailogForm} formType="LeDocForm" backgroundImage="/images/GetStarted4.webp" />
    </div>
  )
}

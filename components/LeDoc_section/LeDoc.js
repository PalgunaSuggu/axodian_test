import { leDocBenefits, leDocFaqs, LeDocHomeSteps, ledocReviews } from '../Data';
...
import StepperFlowGrid from '../Reusable_section/StepperFlowGrid/StepperFlowGrid';
...
const LeDoc = () => {
  return (
    <div>
      ...
      <Benefits subtitleOne="Unlock the Ultimate" subtitleTwo="Benefits with LeDoc" description="Discover the tools and advantages that drive secure, scalable, and compliant trade documentation." benefits={leDocBenefits} />
      <StepperFlowGrid title='Smart, Simple & Scalable – LeDoc Flow' steps={LeDocHomeSteps} />
      <LeDocFeatures />

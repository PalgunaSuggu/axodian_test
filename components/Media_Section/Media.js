            ...
            <div className="container mx-auto">
                ...
                <div className="mt-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        {(showAllData ? filteredData : filteredData.slice(0, 6)).map((data, index) => (
                            <Card key={`${data.source}-${data.id}-${index}`} className="overflow-hidden bg-white rounded-lg shadow-none">

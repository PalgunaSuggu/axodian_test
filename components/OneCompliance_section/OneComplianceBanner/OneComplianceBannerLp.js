    ...
    <div className="min-h-screen w-full bg-[#020617] relative overflow-hidden flex flex-col justify-center items-center">
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 text-center max-w-5xl mx-auto">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm mb-8 animate-fade-in-up">
          ...
          <span className="text-sm font-medium text-gray-300">Now Available</span>
        </div>
        ...
        <p className="text-lg text-gray-400 bg-white/10 backdrop-blur-sm inline-block px-4 py-2 rounded-lg border border-solid border-white/20 mb-10">
          Designed for exporters managing <span className="font-semibold text-white">5+ shipments per month</span>
        </p>

        <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
          <OneComplianceDailogForm defaultSelected={['one_compliance']} showProductOptions={true} redirectTo={redirectTo} buttonText='Book a 15-min Demo'>
...
export default OneComplianceBannerLp;
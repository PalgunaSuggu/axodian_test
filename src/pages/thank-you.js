    ...
    return (
        <>
            ...
            <div className="min-h-screen flex items-center justify-center bg-cover bg-center bg-blue-50 bg-[url('/images/LandingBanner.webp')] px-4 py-12">
                <div className="bg-white/60 p-8 rounded-lg text-center max-w-xl w-full border border-dashed border-blue-300">
                    <CheckCircle className="h-16 w-16 text-green-500 mx-auto mb-4" />
                    <h1 className="text-4xl font-bold text-gray-800 mb-2">{content.heading}</h1>
                    ...
                    <CustomLink
                        href="/"
                        className="inline-block bg-secondary-light-color text-white px-6 py-3 rounded-full text-lg font-semibold transition hover:bg-secondary-light-color"
                    >
                        {content.button}
                    </CustomLink>
                </div>
